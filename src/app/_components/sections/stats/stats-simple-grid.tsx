          ...
          <div className="mx-auto max-w-2xl lg:max-w-none">
            <div className="text-center">
              <h2 className="text-3xl font-bold tracking-tight text-ai-title-regular sm:text-4xl">
                Seamless Car Rentals, Unmatched Convenience
              </h2>
              <p className="mt-4 text-lg leading-8 text-ai-subtext-regular">
                Experience professional, hassle-free car rentals designed to meet all your transportation needs. Book your ride today!
              </p>
            </div>
